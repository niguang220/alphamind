...
# 复制预下载的 ONNX 模型缓存
COPY --from=dependencies /root/.cache/chroma /home/alphamind/.cache/chroma
...
RUN useradd -m -u 1000 alphamind && \
    chown -R alphamind:alphamind /app && \
    chown -R alphamind:alphamind /home/alphamind/.cache
USER alphamind

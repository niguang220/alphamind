...
```bash
# 进入容器
docker-compose exec alphamind bash
...
- 文档: [项目Wiki](https://github.com/your-repo/alphamind/wiki)
- 问题: [GitHub Issues](https://github.com/your-repo/alphamind/issues)
- 讨论: [GitHub Discussions](https://github.com/your-repo/alphamind/discussions)

    ...
    <header className="border-b border-rule bg-desk">
      <div className="flex items-center justify-between gap-6 py-3 pr-6 pl-8">
        <div className="flex items-baseline gap-4">
          <h1 className="font-display text-display leading-none tracking-[-0.01em] text-ink">
            Alpha<span className="text-teal">Mind</span>
          </h1>
          <span className="hidden font-mono text-meta tracking-[0.14em] text-ink-faint uppercase sm:block">
            Research Desk · China A-Shares
          </span>
        </div>
        <div className="flex shrink-0 items-center gap-2">
          <Dot color={color} live={online} />
          <span className="font-mono text-meta tracking-[0.08em] text-ink-mute">{word}</span>
        </div>
      </div>
      ...
      <div className={`${lane} pb-3`}>
        <p className="text-ui leading-[1.5] text-ink-mute">

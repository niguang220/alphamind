...
keywords: research report,broker report,analyst report,financial report,annual report,quarterly report,revenue,net profit,gross margin,fundamentals,valuation,p/e,p/b,pe ratio,roe,percentile,factor,backtest,sharpe,drawdown,volatility,compare,comparison,tracking error
agents: research
enabled: true
---
